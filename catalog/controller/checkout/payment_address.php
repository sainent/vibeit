...
class ControllerCheckoutPaymentAddress extends Controller {
	public function index() {
		...
		if($this->customer->isLogged() && !empty($this->customer->getAddressId())) {
			foreach($data['addresses'] as $add){
				if($add['address_id'] == $this->customer->getAddressId()){
		...
		$data['returntohome'] = $this->url->link('common/home', '', true);
